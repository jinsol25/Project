...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="${contextPath}/">Spring Blog</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
     ...
     <c:if test="${!empty mvo}">
      <ul class="nav navbar-nav navbar-right">
       <li><a href="${contextPath}/memUpdateForm.do"><span class="glyphicon glyphicon-edit"></span> 회원정보 수정</a></li>
	   ...
	   <c:if test="${!empty mvo}">
    	 ...
    	 <li><img class="img-circle" src="${contextPath}/resources/images/default.png" style="width: 50px; height: 50px" /> ${mvo.memName}님 Welcome!</li>
        </c:if>
