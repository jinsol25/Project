  ...
  <script type="text/javascript">
    ...
    function loadList(){
  	...
  	function makeView(data) {	
		...
		$("#view").css("display", "block");		// x
		$("#wform").css("display", "none");		// o
  	}
  	
  	function goForm() {
		$("#view").css("display", "none");		// x
		$("#wform").css("display", "block");	// o
	}
  	...
  	function goContent(idx) {	//idx=11, 10, 5
  		if($("#c"+idx).css("display")=="none") {
  			...
  			$("#c"+idx).css("display", "table-row");	// o
  			$("#ta"+idx).attr("readonly", true);
  		} else {
  			$("#c"+idx).css("display", "none");			// x
  			$.ajax({
  				url : "board/count/"+idx,
  				type : "put",
  				dataType : "json",
